...
def arr_to_c_arr_string(temp_voltage_map):
    ...
    result_arr_str.append(f"float MIN_MAP_TEMP = {temp_voltage_map[0][0]};")
    result_arr_str.append(f"float MAX_MAP_TEMP = {temp_voltage_map[-1][0]};")
    result_arr_str.append(f"float MIN_MAP_VOLT = {temp_voltage_map[-1][1]};")
    result_arr_str.append(f"float MAX_MAP_VOLT = {temp_voltage_map[0][1]};")
